...
import { ITEM_CATEGORIES } from "./data";
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col-reverse lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
                ...
                <div className="flex overflow-x-auto pb-2 gap-3 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] w-full lg:w-auto">
                    {ITEM_CATEGORIES.slice(0, 6).map(category => ( // Just show some to match image
                        <button
                            key={category}
                            onClick={() => setActiveCategory(category)}
                            className={`whitespace-nowrap px-6 py-2 rounded-full text-sm font-bold transition-all shadow-sm ${activeCategory === category
