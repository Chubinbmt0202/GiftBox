...
export function CartPreviewSidebar({
    ...
    return (
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100/50 flex flex-col gap-5 ">
            ...
            <div className="border-t border-gray-100 pt-3 mt-1">
                ...
                {currentStep < 3 ? (
                    ...
                    <button
                        onClick={onComplete}
                        className={`w-full py-3 rounded-xl font-bold text-sm transition-all shadow-sm ${!selectedCard
                            ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
