        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-4 lg:gap-6">
            {MOCK_BOXES.map(box => (
                <div
                    ...
                    className={`bg-white p-3 lg:p-4 rounded-[2rem] border-2 cursor-pointer shadow-sm transition-all group flex flex-col ${selectedBox?.id === box.id
                            ? 'border-boonie-pink'
                    ...
                    <div className="flex-1 flex flex-col justify-between px-1">
                        <div className="mb-3">
                            <div className="flex flex-col mb-1 gap-1">
                                ...
                                <span className="text-boonie-pink font-semibold text-sm lg:text-base">{box.price.toLocaleString()}₫</span>
                            </div>
